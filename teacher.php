        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <?php foreach(range(date(2025,time()),1999) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="code" placeholder="Code , Eg : CSA-151">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 001/CS/19)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 063/CS/19)">
